...
INSERT INTO `tb_article` VALUES (56, 1, 187, 'http://datoudidi.cn/e7dbae69-00dc-4f55-a25c-7e7094a37c8e.png', '2022-05-08 测试一则', '# 小周要加油\n## 天天开心\n```\nhello world\n```\n![552fee198618367a8450fe152f738bd4b11ce598.jpg](http://datoudidi.cn/a7bacfaf-57da-4eb4-a70a-61dfa7ab13ed.jpg)', 1, '', 1, 0, 1, '2022-05-08 19:57:55', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 870 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tb_article_tag
-- ----------------------------
INSERT INTO `tb_article_tag` VALUES (867, 56, 29);
INSERT INTO `tb_article_tag` VALUES (868, 54, 29);
INSERT INTO `tb_article_tag` VALUES (869, 54, 30);
...
-- ----------------------------
INSERT INTO `tb_category` VALUES (187, '小周的精神世界', '2022-01-24 23:33:56', NULL);
...
CREATE TABLE `tb_chat_record`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2996 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tb_chat_record
-- ----------------------------
INSERT INTO `tb_chat_record` VALUES (2990, 1011, 'dd测试一号机', 'http://datoudidi.cn/8ca3dfa9-3a36-4855-bf35-3d886cbbd59f.jpg', '你好', '未知ip', '', 3, '2022-05-23 17:13:46', NULL);
INSERT INTO `tb_chat_record` VALUES (2991, NULL, '未知ip', 'https://static.talkxj.com/photos/0bca52afdb2b9998132355d716390c9f.png', '你好我好大家好', '未知ip', '', 3, '2022-05-23 17:13:55', NULL);
INSERT INTO `tb_chat_record` VALUES (2992, 1011, 'dd测试一号机', 'http://datoudidi.cn/8ca3dfa9-3a36-4855-bf35-3d886cbbd59f.jpg', '<img src= \'https://static.talkxj.com/emoji/smile.jpg\' width=\'24\'height=\'24\' style=\'margin: 0 1px;vertical-align: text-bottom\'/>', '未知ip', '', 3, '2022-05-23 17:14:04', NULL);
INSERT INTO `tb_chat_record` VALUES (2993, NULL, '未知ip', 'https://static.talkxj.com/photos/0bca52afdb2b9998132355d716390c9f.png', '<img src= \'https://static.talkxj.com/emoji/oh.jpg\' width=\'24\'height=\'24\' style=\'margin: 0 1px;vertical-align: text-bottom\'/>', '未知ip', '', 3, '2022-05-24 14:14:37', NULL);
INSERT INTO `tb_chat_record` VALUES (2994, NULL, '未知ip', 'https://static.talkxj.com/photos/0bca52afdb2b9998132355d716390c9f.png', '你好你能收到我的消息吗？', '未知ip', '', 3, '2022-05-24 14:45:43', NULL);
INSERT INTO `tb_chat_record` VALUES (2995, 1011, 'dd测试一号机', 'http://datoudidi.cn/8ca3dfa9-3a36-4855-bf35-3d886cbbd59f.jpg', '我能收到你的消息', '未知ip', '', 3, '2022-05-24 14:46:41', NULL);
...
CREATE TABLE `tb_message`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3944 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_message` VALUES (3939, '游客', 'https://static.talkxj.com/photos/0bca52afdb2b9998132355d716390c9f.png', 'test', '127.0.0.1', '', 9, 1, '2022-05-05 14:49:27', NULL);
INSERT INTO `tb_message` VALUES (3940, '游客', 'https://static.talkxj.com/photos/0bca52afdb2b9998132355d716390c9f.png', 'test', '127.0.0.1', '', 9, 1, '2022-05-05 15:01:05', NULL);
INSERT INTO `tb_message` VALUES (3941, '游客', 'https://static.talkxj.com/photos/0bca52afdb2b9998132355d716390c9f.png', '游客测试', '127.0.0.1', '', 9, 1, '2022-05-05 15:05:04', NULL);
INSERT INTO `tb_message` VALUES (3942, '游客', 'https://static.talkxj.com/photos/0bca52afdb2b9998132355d716390c9f.png', '测试游客留言', '127.0.0.1', '', 8, 1, '2022-05-05 15:09:16', NULL);
INSERT INTO `tb_message` VALUES (3943, '底迪测试机一号', 'http://datoudidi.cn/cc0b15ea-11a9-42f3-be7e-e198ed729360.jpg', '测试用户留言', '127.0.0.1', '', 7, 1, '2022-05-05 15:10:20', NULL);
...
CREATE TABLE `tb_operation_log`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1088 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_operation_log` VALUES (1084, '相册模块', '新增或修改', '/admin/photos/albums', 'com.dd.blog.controller.PhotoAlbumsController.saveOrUpdatePhotoAlbum', '保存或更新相册', '[{\"albumCover\":\"http://datoudidi.cn/a404de5c-2b0d-4cfc-af89-6decfe1d1e28.JPG\",\"albumDesc\":\"记录2019重庆之行\",\"albumName\":\"重庆Plog\",\"status\":1}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-20 17:26:58', NULL);
INSERT INTO `tb_operation_log` VALUES (1085, '照片模块', '新增', '/admin/photos', 'com.dd.blog.controller.PhotoController.savePhotos', '保存照片', '[{\"albumId\":8,\"photoUrlList\":[\"http://datoudidi.cn/d31e9d9a-c7ab-4b05-9f04-52a0118f4959.JPG\",\"http://datoudidi.cn/12eae25b-789d-4b1d-b208-7460a27a7a99.JPG\",\"http://datoudidi.cn/2df945fa-26b7-42be-b4e5-46b1d6ee0c82.JPG\"]}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-20 17:27:48', NULL);
INSERT INTO `tb_operation_log` VALUES (1086, '相册模块', '新增或修改', '/admin/photos/albums', 'com.dd.blog.controller.PhotoAlbumsController.saveOrUpdatePhotoAlbum', '保存或更新相册', '[{\"albumCover\":\"http://datoudidi.cn/lonely.jpg\",\"albumDesc\":\"4k图片\",\"albumName\":\"4k\",\"id\":1,\"status\":1}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-20 17:28:27', NULL);
INSERT INTO `tb_operation_log` VALUES (1087, '评论模块', '修改', '/admin/comments/review', 'com.dd.blog.controller.CommentController.updateCommentsReview', '审核评论', '[{\"idList\":[726],\"isReview\":1}]', 'PUT', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-21 23:50:02', NULL);
...
-- Records of tb_page
-- ----------------------------
INSERT INTO `tb_page` VALUES (1, '首页', 'home', 'http://datoudidi.cn/about.jpg', '2021-08-07 10:32:36', '2021-12-27 12:19:01');
INSERT INTO `tb_page` VALUES (2, '归档', 'archive', 'http://datoudidi.cn/3f152eb3-8507-4af1-8b1c-4284e1b27e1d.png', '2021-08-07 10:32:36', NULL);
INSERT INTO `tb_page` VALUES (3, '分类', 'category', 'http://datoudidi.cn/jiangshi.jpg', '2021-08-07 10:32:36', '2021-10-04 15:43:31');
INSERT INTO `tb_page` VALUES (4, '标签', 'tag', 'http://datoudidi.cn/wallhaven-g7qy5l.jpg', '2021-08-07 10:32:36', '2021-10-04 15:43:38');
INSERT INTO `tb_page` VALUES (5, '相册', 'album', 'http://datoudidi.cn/xingqiudazhan.jpg', '2021-08-07 10:32:36', '2021-12-27 12:23:12');
INSERT INTO `tb_page` VALUES (6, '友链', 'link', 'http://datoudidi.cn/lonely.jpg', '2021-08-07 10:32:36', '2021-10-04 15:44:02');
INSERT INTO `tb_page` VALUES (7, '关于', 'about', 'http://datoudidi.cn/pokemon.jpg', '2021-08-07 10:32:36', '2021-10-04 15:44:08');
INSERT INTO `tb_page` VALUES (8, '留言', 'message', 'http://datoudidi.cn/blue.png', '2021-08-07 10:32:36', '2021-10-04 16:11:45');
INSERT INTO `tb_page` VALUES (9, '个人中心', 'user', 'http://datoudidi.cn/dadiannao.jpg', '2021-08-07 10:32:36', '2021-10-04 15:45:17');
INSERT INTO `tb_page` VALUES (10, '文章列表', 'articleList', 'http://datoudidi.cn/doudou.png', '2021-08-10 15:36:19', '2021-10-04 15:45:45');
INSERT INTO `tb_page` VALUES (904, '说说', 'talk', 'http://datoudidi.cn/yazi.png', '2022-01-23 00:51:24', '2022-01-23 03:01:21');
...
-- Records of tb_photo
-- ----------------------------
INSERT INTO `tb_photo` VALUES (1, 1, '测试照片', '测试照片是否能正确显示', 'http://datoudidi.cn/lonely.jpg', 0, '2022-05-02 17:32:36', NULL);
INSERT INTO `tb_photo` VALUES (29, 8, '1527581844067966977', NULL, 'http://datoudidi.cn/d31e9d9a-c7ab-4b05-9f04-52a0118f4959.JPG', 0, '2022-05-20 17:27:47', NULL);
INSERT INTO `tb_photo` VALUES (30, 8, '1527581844067966978', NULL, 'http://datoudidi.cn/12eae25b-789d-4b1d-b208-7460a27a7a99.JPG', 0, '2022-05-20 17:27:47', NULL);
INSERT INTO `tb_photo` VALUES (31, 8, '1527581844067966979', NULL, 'http://datoudidi.cn/2df945fa-26b7-42be-b4e5-46b1d6ee0c82.JPG', 0, '2022-05-20 17:27:47', NULL);
...
-- ----------------------------
INSERT INTO `tb_photo_album` VALUES (1, '4k', '4k图片', 'http://datoudidi.cn/lonely.jpg', 0, 1, '2022-05-02 17:31:07', NULL);
INSERT INTO `tb_photo_album` VALUES (8, '重庆Plog', '记录2019年重庆之行', 'http://datoudidi.cn/a813ca19-1d1e-44e4-9aca-938c785e4052.JPG', 0, 1, '2022-05-20 17:14:47', NULL);
...
INSERT INTO `tb_role` VALUES (2, '用户', 'user', 0, '2021-03-22 14:25:25', NULL);
...
CREATE TABLE `tb_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2531 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_role_menu` VALUES (2528, 2, 1);
INSERT INTO `tb_role_menu` VALUES (2529, 2, 2);
INSERT INTO `tb_role_menu` VALUES (2530, 2, 6);
...
CREATE TABLE `tb_role_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4890 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_role_resource` VALUES (4888, 2, 186);
INSERT INTO `tb_role_resource` VALUES (4889, 2, 189);
...
-- Records of tb_tag
-- ----------------------------
INSERT INTO `tb_tag` VALUES (29, '心情', '2022-01-24 23:33:57', NULL);
INSERT INTO `tb_tag` VALUES (30, 'Java', '2022-05-18 14:55:56', NULL);
...
-- ----------------------------
INSERT INTO `tb_unique_view` VALUES (1, 2, '2022-05-04 22:55:35', '2022-05-07 22:55:39');
...
-- ----------------------------
INSERT INTO `tb_user_auth` VALUES (1, 1, 'admin@qq.com', '$2a$10$b9kh8eQMGP1FWatYLinpyOV/Xvaq23C5vSfMWi7UOS5LYRcsQqADO', 1, '127.0.0.1', '未知', '2021-08-12 15:43:18', NULL, '2022-05-24 14:29:03');
...
INSERT INTO `tb_user_auth` VALUES (999, 1011, '765327432@qq.com', '$2a$10$oSWuLGwHE5z4UfowxnqCv.sACO3r92X4Da945Gj10wEC6ap1uxZ1O', 1, '127.0.0.1', '未知', '2022-05-16 23:22:27', NULL, '2022-05-24 14:46:28');
...
-- ----------------------------
INSERT INTO `tb_user_info` VALUES (1, 'admin@qq.com', '管理员', 'http://datoudidi.cn/4142578a-5cc8-4139-9724-0cb18a0ba37d.jpg', '我是管理员', NULL, 0, '2021-08-12 15:43:17', NULL);
...
INSERT INTO `tb_user_info` VALUES (1011, '765327432@qq.com', 'dd测试一号机', 'http://datoudidi.cn/8ca3dfa9-3a36-4855-bf35-3d886cbbd59f.jpg', '我是sb', 'www.4399.com', 0, '2022-05-16 23:22:27', NULL);
...
INSERT INTO `tb_user_role` VALUES (1007, 1011, 2);
...
-- ----------------------------
INSERT INTO `tb_website_config` VALUES (1, '{\"alipayQRCode\":\"http://datoudidi.cn/d080d64c-4d55-4939-b7b7-5cf036b0a109.png\",\"gitee\":\"\",\"github\":\"\",\"isChatRoom\":1,\"isCommentReview\":0,\"isEmailNotice\":0,\"isMessageReview\":0,\"isMusicPlayer\":0,\"isReward\":1,\"qq\":\"765327432\",\"socialLoginList\":[\"qq\"],\"socialUrlList\":[\"qq\"],\"touristAvatar\":\"https://static.talkxj.com/photos/0bca52afdb2b9998132355d716390c9f.png\",\"userAvatar\":\"http://datoudidi.cn/nologin\",\"websiteAuthor\":\"底迪\",\"websiteAvatar\":\"http://datoudidi.cn/d224f690-3fa7-4621-86f3-704914158880.jpg\",\"websiteCreateTime\":\"2022-04-18\",\"websiteIntro\":\"观看愉快~\",\"websiteName\":\"底迪的宇宙空间站\",\"websiteNotice\":\"小周要开心\",\"websiteRecordNo\":\"桂ICP备2022003417号-1\",\"websocketUrl\":\"ws://127.0.0.1:8080/websocket\",\"weiXinQRCode\":\"http://datoudidi.cn/7d6eeacc-bf18-41db-b8e8-488fe743d5d5.png\"}', '2021-08-09 19:37:30', NULL);
