...
public class OptLogAspect {
     ...
     */
    @Pointcut("@annotation(com.dd.blog.annotation.OptLog)")
    ...
    public void saveOptLog(JoinPoint joinPoint, Object keys) {
        ...
        // 请求用户ID
        operationLog.setUserId(UserThreadLocal.get().getUserId());
        // 请求用户
        UserInfo userInfo = userInfoDao.selectOne(new LambdaQueryWrapper<UserInfo>()
                .select(UserInfo::getNickname)
                .eq(UserInfo::getId, UserThreadLocal.get().getUserId()));
        operationLog.setNickname(userInfo.getNickname());
        // 请求IP
